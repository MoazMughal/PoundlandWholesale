  ...
  const fetchProduct = async () => {
    try {
      ...
      setFormData({
        ...
        dealUnits: product.dealUnits || Math.floor((product.platformUnits || 2400) / 12),
        platformUnits: product.platformUnits !== undefined && product.platformUnits !== null ? product.platformUnits : (product.dealUnits ? product.dealUnits * 12 : 2400),
    ...
    try {
      ...
      if (validFiles.length > 0) {
        ...
        productData = {
          ...
          dealUnits: parseInt(formData.dealUnits) || Math.floor((formData.platformUnits || 2400) / 12),
